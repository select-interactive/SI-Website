...
/* si.home */
(function(k,a){function d(){function f(d){b.data("class");c?(b.removeClass("in"),g.removeClass("in")):b.fadeOut(1E3);d?0>--e&&(e=h.length-1):++e===h.length&&(e=0);b=a(h[e]);c?b.addClass("in"):b.fadeIn(1E3);setTimeout(function(){g.html(b.data("text"));c&&g.addClass("in")},475);i=setTimeout(f,4E3)}var j=a("#cycle");a("#cycle-overlay");var d=j.find(".arrow"),g=a("#specialize-text"),h=j.find("img"),b=h.filter(".in"),i=null,e=0,c=Modernizr.csstransitions;g.html(b.data("text"));!c&&a(".arrow").fadeTo(0, 0.7);d.on("mouseenter",function(){!c&&a(this).fadeTo(300,0.95)}).on("mouseleave",function(){!c&&a(this).fadeTo(300,0.7)}).on("click",function(b){b.preventDefault();clearTimeout(i);"prev"===a(this).attr("id")?f(!0):f()});i=setTimeout(f,5E3)}window.si=window.si||{};a(function(){a("header, nav, #content-wrapper, footer").addClass("in");d()})})(document,jQuery);