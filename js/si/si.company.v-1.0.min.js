...
/* si.company */
(function(c,a){function b(){a(".img-wrapper").find("img").on("mouseenter",function(){a(this).removeClass("skewed").addClass("normal")}).on("mouseleave",function(){a(this).removeClass("normal").addClass("skewed")})}window.si=window.si||{};a(function(){b()})})(document,jQuery);